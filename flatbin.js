...
FLATBIN.Reader = (function() {
     ...
     * @return {Object}
     */
    Reader.prototype.object = function(expectedType) {
     ...
     * @return {Object}
     */
    Reader.prototype.vector = function(expectedType, dim) {
     ...
     * @return {Object}
     */
    Reader.prototype.vtable = function(ptr) {
     ...
     */
    Reader.prototype.registerTable = function(name, fields) {
     ...
     * @param {Array} fields ordered list of string-function pairs
     */
    Reader.prototype.registerStruct = function(name, fields) {
